...
CREATE TABLE `havaalanlari` (
  ...
  `HAVAALANI_ISMI` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `havaalanlari`
--

LOCK TABLES `havaalanlari` WRITE;
/*!40000 ALTER TABLE `havaalanlari` DISABLE KEYS */;
/*!40000 ALTER TABLE `havaalanlari` ENABLE KEYS */;
UNLOCK TABLES;
